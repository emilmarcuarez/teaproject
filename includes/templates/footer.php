...
<footer class="footer">
    <div class="contenedor">
        <div class="redes-sociales">
         ...
         <p class="copyright">Equipo de Tea Pzo. Todos los derechos Reservados. 2023 &copy;</p>
    </div>
...
<!-- <script src="/teaproyect/src/js/app.js"></script> -->
<script src="/teaproyect/build/js/bundle.min.js"></script>
</body>
